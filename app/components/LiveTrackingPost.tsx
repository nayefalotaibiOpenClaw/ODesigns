...
export default function LiveTrackingPost() {
  ...
  return (
    <div className="relative w-full h-full shadow-2xl overflow-hidden mx-auto font-sans"
      ...
      {/* Glow */}
      <div className={`absolute -bottom-20 -left-20 w-[400px] h-[400px] opacity-[0.1] blur-[100px] rounded-full ${isEditMode ? '' : 'animate-pulse-slow'}`}
      ...
      <div className="relative z-10 w-full h-full flex flex-col p-8">
        ...
        <DraggableWrapper id="headline-tracking" className={`mt-6 text-right z-30 ${isEditMode ? '' : 'animate-reveal'}`} dir="rtl">
        ...
        <div className="flex-1 flex items-end justify-start relative mt-2">
          ...
          <DraggableWrapper
            ...
            className={`relative z-20 transition-all duration-500 ${isTall ? 'w-[270px] h-[520px]' : 'w-[210px] h-[370px]'} ${isEditMode ? '' : 'animate-zoom-in animate-stagger-2'}`}
          >
          ...
          <FloatingCard
            ...
            label="ETA"
            value="12 min"
            className={`absolute right-4 top-[10%] z-30 ${isEditMode ? '' : 'animate-slide-left animate-stagger-3'}`}
            rotate={-4}
          ...
          <FloatingCard
            ...
            label="Active Orders"
            value="8"
            className={`absolute right-8 bottom-[30%] z-30 ${isEditMode ? '' : 'animate-slide-right animate-stagger-4'}`}
            rotate={3}
