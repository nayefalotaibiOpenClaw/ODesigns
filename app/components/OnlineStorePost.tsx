...
export default function OnlineStorePost() {
  return (
      <div className="relative w-full max-w-[600px] aspect-square shadow-2xl rounded-xl overflow-hidden mx-auto bg-[#1B4332] text-white font-sans">
            ...
            {/* Background Blob */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-[#40916C]/30 rounded-full blur-[100px]"></div>
            ...
            <div className="relative z-10 w-full h-full flex flex-col items-center justify-between p-8">
                ...
                <div className="text-center mt-6">
                    <h2 className="text-4xl sm:text-5xl font-black mb-2 text-[#52B788] leading-tight">
                        موقعك
                        <br/>
                ...
                <div className="w-full max-w-xs relative flex justify-center">
                    ...
                    <div className="w-48 h-80 bg-black rounded-[2rem] border-[6px] border-gray-800 shadow-2xl relative overflow-hidden z-10 transform -rotate-3 hover:rotate-0 transition-transform duration-500">
                         ...
                         {/* Screen Content */}
                         <div className="w-full h-full bg-[#EAF4EE] pt-8 px-3 flex flex-col items-center">
                             {/* Fake Navbar */}
                             <div className="w-full flex justify-between items-center mb-4">
                                 <div className="w-6 h-6 bg-gray-200 rounded-full"></div>
                                 <div className="w-20 h-2 bg-gray-200 rounded-full"></div>
                                 <ShoppingCart size={16} className="text-[#1B4332]" />
                             </div>

                             {/* Hero Image */}
                             <div className="w-full h-24 bg-[#52B788]/20 rounded-xl mb-3 flex items-center justify-center">
                                 <div className="w-10 h-10 bg-[#52B788] rounded-full opacity-50"></div>
                             </div>
                             ...
                             <div className="w-full space-y-2">
                                 {[1, 2, 3].map((i) => (
                                     <div key={i} className="flex gap-2 items-center bg-white p-2 rounded-lg shadow-sm">
                                         ...
                                         <div className="w-4 h-4 bg-[#1B4332] text-white rounded flex items-center justify-center text-[8px] font-bold">+</div>
                                     </div>
                                 ))}
                             </div>

                             {/* Checkout Button */}
                             <div className="mt-auto mb-4 w-full bg-[#1B4332] text-white text-[10px] font-bold py-2 rounded-lg text-center">
                                 إتمام الطلب
                             </div>
                         </div>
                    </div>
                    ...
                    {/* Background Circle */}
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 border border-[#40916C]/20 rounded-full animate-spin-slow-reverse"></div>
                </div>
