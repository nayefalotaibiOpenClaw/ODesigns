  ...
  return (
    <div className="relative w-full max-w-[600px] aspect-square shadow-2xl rounded-xl overflow-hidden mx-auto font-sans"
      ...
      <div className="relative z-10 w-full h-full flex flex-col p-8">
        ...
        <DraggableWrapper id="headline-pay" className="mt-8 text-right z-30" dir="rtl">
        ...
        <div className="flex-1 flex items-center justify-center relative mt-4">
          <DraggableWrapper id="mockup-pay" className={`relative z-20 transition-all duration-500 ${isTall ? 'w-[300px] h-[580px]' : 'w-[230px] h-[360px]'}`}>
          ...
          <FloatingCard 
            ...
            label="Payment Speed" 
            value="< 2 Sec" 
            className="absolute -right-6 top-1/3 z-30" 
            rotate={-2}
          ...
          <FloatingCard 
            ...
            label="Security" 
            value="Encrypted" 
            className="absolute -left-10 top-1/4 z-30" 
            rotate={4}
          />

          <div className="absolute -bottom-4 right-1/4 z-30 opacity-40">
