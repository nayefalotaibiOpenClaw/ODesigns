    ...
    <div className="relative w-full h-full shadow-2xl overflow-hidden mx-auto font-sans"
      ...
      <div className="relative z-10 w-full h-full flex flex-col p-8">
        ...
        <div className="flex-1 flex items-center justify-center relative mt-4">
          <DraggableWrapper id="mockup-pay" variant="mockup" className={`relative z-20 transition-all duration-500 ${isTall ? 'w-[300px] h-[580px]' : 'w-[230px] h-[360px]'} ${isEditMode ? '' : 'animate-zoom-in animate-stagger-2'}`}>
