      ...
      <div className="relative z-10 w-full h-full flex flex-col p-8">
        ...
        <div className="flex-1 flex items-center justify-center relative mt-4">
           ...
           <DraggableWrapper id="mockup-mobile" className={`relative z-20 ${isTall ? 'w-[300px] h-[580px]' : 'w-[230px] h-[360px]'}`}>
              ...
              <div className="absolute -left-[7px] top-24 w-[3px] h-12 bg-[#254d3c] rounded-l-md"></div>
              <div className="absolute -left-[7px] top-40 w-[3px] h-12 bg-[#254d3c] rounded-l-md"></div>
              <div className="absolute -right-[7px] top-32 w-[3px] h-16 bg-[#254d3c] rounded-r-md"></div>
           ...
           {/* Floating Stat Card */}
           <DraggableWrapper id="stat-card-mobile" className="absolute -right-8 top-16 bg-[#EAF4EE] p-3 rounded-2xl shadow-2xl flex items-center gap-3 transform rotate-3 border-2 border-[#B7FF5B] z-30">
        ...
        <div className="mt-auto flex justify-between items-end border-t border-white/10 pt-6" dir="rtl">
           ...
           <DraggableWrapper id="footer-icon-mobile" className="w-12 h-12 bg-[#B7FF5B] rounded-2xl flex items-center justify-center text-[#1B4332] shadow-[0_0_20px_rgba(183,255,91,0.2)]">
              <Smartphone size={24} />
           </DraggableWrapper>
        </div>
