  ...
  },
  {
    ...
    locales: {
      ar: {
        ...
        metaTitle: "قوالب منشورات إعلانات وإطلاقات بالذكاء الاصطناعي | oDesigns",
        metaDescription: "أنشئ منشورات إعلانات علامة تجارية احترافية بالذكاء الاصطناعي. قوالب لإطلاق المنتجات وأخبار الشركة والإنجازات وإعلانات الفعاليات.",
        heroTitle: "إعلانات تفرض الانتباه",
        heroSubtitle: "الأخبار الكبيرة تستحق تصميماً كبيراً. أنشئ منشورات إعلانات احترافية لإطلاق المنتجات وإنجازات الشركة والفعاليات والتحديثات.",
        examples: [
          { title: "عد تنازلي لإطلاق منتج", description: "ابنِ الترقب بسلسلة منشورات عد تنازلي تقود ليوم الإطلاق. تصميم تشويقي متسق يخلق حماساً." },
          { title: "احتفال بإنجاز الشركة", description: "احتفل بالإنجازات — ذكرى سنوية، إنجاز مستخدمين، جوائز — بطباعة بارزة وألوان علامتك." },
          { title: "إعلان وتذكير فعالية", description: "أنشئ منشورات فعاليات بالتاريخ والوقت والموقع وتفاصيل التسجيل. جدوِل تذكيرات قبل الفعالية." },
          { title: "إصدار ميزة أو تحديث", description: "أعلن عن ميزات جديدة وتحديثات وتحسينات بتصاميم نظيفة تبرز الجديد وأهميته." },
        ],
        tips: [
          { title: "أنشئ حملة، لا منشوراً واحداً", description: "الإعلانات الكبيرة تعمل أفضل كسلسلة: تشويق، كشف، تفاصيل، تذكير. أنشئ التسلسل كاملاً وجدوِله عبر أيام." },
          { title: "الطباعة البارزة تفوز", description: "منشورات الإعلانات يجب أن تبدو مهمة. استخدم أحجام عناوين أكبر وأوزان أجرأ وتباينات ألوان عالية." },
          { title: "ضمّن التفاصيل الأساسية مقدماً", description: "ماذا ومتى وأين وكيف. لا تجعل المتابعين يبحثون في التعليق عن المعلومات الأساسية — ضعها في التصميم." },
          { title: "انشر في كل مكان", description: "الإعلانات يجب أن تصل كل قناة في وقت واحد. انشر على جميع منصاتك المتصلة بنقرة واحدة." },
        ],
        cta: { title: "أنشئ منشور إعلانك القادم", subtitle: "صِف أخبارك. الذكاء الاصطناعي ينشئ تصاميم إعلانات احترافية في ثوانٍ. مجاني للبدء." },
      },
    },
  },
];
